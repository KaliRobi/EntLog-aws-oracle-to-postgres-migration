...
-- Create the schema
CREATE USER entlog IDENTIFIED BY EntsAreAwesome123;

-- Grant necessary privileges
GRANT CONNECT, RESOURCE TO entlog;
GRANT CREATE SESSION TO entlog;

-- Switch to the EntLog schema
ALTER SESSION SET CURRENT_SCHEMA = entlog;

-- Table: Ents
-- Ents, who are the true carriers of the forest (business profile: reliable, bit slow)
CREATE TABLE ents (
    ent_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
...
CREATE TABLE treestumps (
    stump_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, 
